                ...
                <div class="card-inner">
                    <div class="card-title-group">
                        <div class="card-title">
                            <h6 class="text-body"><strong class="text-primary small">{{ $user->name }}</strong> / Subject / <strong class="text-primary small">{{ $exam->title }}</strong> / Result</h6>
                        </div>
                            ...
                            <div class="row ">
                                <div class="col-md-5  ">
                                    <div class="profile-ud wider " >
                                        ...
                                        <span class="profile-ud-value">{{ $show->correct_answer + $show->wrong_answer }}</span>
                                    </div>
                                    <div class="profile-ud wider">
                                ...
                                <div class="col-md-5 ">
                                    <div class="profile-ud wider">
                                        ...
                                        <span class="profile-ud-value">{{ $show->grade }}</span>
                                    </div>
                                    <div class="profile-ud wider">
                                        <span class="profile-ud-label" style="width: 300px">Obtained Exam Marks</span>
                                        <span class="profile-ud-value">{{ $show->obtained_exam_marks }}</span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
